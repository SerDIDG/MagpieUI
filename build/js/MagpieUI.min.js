...
url:"",lang:{},dotFiles:!1,useBrowserHistory:!1,resizable:!1,commandsOptions:{getfile:{folders:!1,multiple:!1}}}}},function(a){var b=this;b.processType=null,b.processCallback=null,Com.AbstractFileManager.apply(b,arguments)}),cm.getConstructor("Com.elFinderFileManager",function(a,b,c){var d=c._inherit;c.construct=function(){var a=this;return a.selectFileEventHandler=a.selectFileEvent.bind(a),a.getFilesEventHandler=a.getFilesEvent.bind(a),d.prototype.construct.apply(a,arguments),a},c.get=function(a){var b=this;return b.processType="get",b.processCallback=a||function(){},b.components.controller?b.components.controller.exec("getfile"):d.prototype.get.apply(b,arguments),null},c.getFiles=function(a){var b=this;return b.processType="getFiles",b.processCallback=a||function(){},b.components.controller?b.components.controller.exec("getfile"):d.prototype.getFiles.apply(b,arguments),null},c.complete=function(a){var b=this;return b.processType="complete",b.processCallback=a||function(){},b.components.controller?b.components.controller.exec("getfile"):d.prototype.complete.apply(b,arguments),b.items},c.renderViewModel=function(){var a=this;return"undefined"!=typeof elFinder?(a.components.controller=new elFinder(a.nodes.holder.inner,cm.merge(a.params.config,{commandsOptions:{getfile:{multiple:a.isMultiple}},getFileCallback:a.getFilesEventHandler})),cm.removeClass(a.nodes.holder.container,"is-hidden"),a.components.controller.show()):cm.errorLog({name:a._name.full,message:["elFinder does not exists."].join(" ")}),a},c.getFilesEvent=function(a){var b=this;switch(b.processFiles(a),b.processType){case"get":d.prototype.get.call(b,b.processCallback);break;case"getFiles":d.prototype.getFiles.call(b,b.processCallback);break;case"complete":d.prototype.complete.call(b,b.processCallback);break;default:d.prototype.complete.call(b)}return b.processType=null,b},c.selectFileEvent=function(a){var b,c=this,d=a.data.selected,e=[];d.length&&cm.forEach(d,function(a){b=c.components.controller.file(a),b&&e.push(b)}),c.processFiles(e)},c.convertFile=function(a){return a&&"directory"!=a.mime?{value:a.url,name:a.name,mime:a.mime,size:a.size,url:a.url}:!1}}),cm.define("Com.elFinderFileManagerContainer",{extend:"Com.AbstractFileManagerContainer",params:{constructor:"Com.elFinderFileManager"}},function(a){var b=this;Com.AbstractFileManagerContainer.apply(b,arguments)});