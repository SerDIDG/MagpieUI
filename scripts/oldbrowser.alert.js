Com['OldBrowserAlert'] = function(o){
	...
	var init = function(){
		cm.foreach(config['versions'], function(browser, version){
	...
	var render = function(){
		// Structure
		nodes['container'] = cm.Node('div', {'class' : 'oldbrowser-alert'},
			cm.Node('div', {'class' : 'descr'},
				cm.Node('p', {'innerHTML' : config['langs']['descr']})
			),
			cm.Node('ul', {'class' : 'browsers'},
				cm.Node('li',
					cm.Node('a', {'class' : 'icon chrome', 'title' : 'Google Chrome', 'href' : 'http://www.google.com/chrome/', 'target' : '_blank'})
				),
				cm.Node('li',
					cm.Node('a', {'class' : 'icon firefox', 'title' : 'Mozilla Firefox', 'href' : 'http://www.mozilla.com/', 'target' : '_blank'})
				),
				cm.Node('li',
					cm.Node('a', {'class' : 'icon safari', 'title' : 'Apple Safari', 'href' : 'http://www.apple.com/safari/', 'target' : '_blank'})
				),
				cm.Node('li',
					cm.Node('a', {'class' : 'icon msie', 'title' : 'Microsoft Internet Explorer', 'href' : 'http://ie.microsoft.com/', 'target' : '_blank'})
				)
			),
