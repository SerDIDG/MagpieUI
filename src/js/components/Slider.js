            ...
            that.nodes.inner = cm.node('div', {classes: 'inner'},
                ...
                that.nodes.controls = cm.node('div', {classes: 'com__gallery-controls'},
                    cm.node('div', {classes: 'inner'},
                        that.nodes.prev = cm.node('div', {classes: 'bar-arrow prev', title: that.msg('prev'), role: 'button', tabindex: 0},
                            cm.node('div', {classes: 'icon default prev'})
                        ),
                        that.nodes.next = cm.node('div', {classes: 'bar-arrow next', title: that.msg('next'), role: 'button', tabindex: 0},
